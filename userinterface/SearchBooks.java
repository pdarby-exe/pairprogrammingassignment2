...
//==============================================================
public class SearchBooks extends View
{

    // GUI components
    protected TextField SearchBooks;
    ...
    //----------------------------------------------------------
    public SearchBooks(IModel Book)
    {
        super(Book, "BookView");
    ...
    private VBox createFormContent()
    {
        ...
        Text searchLabel = new Text(" Search For Books: ");
        ...
        SearchBooks.setEditable(true);
        grid.add(SearchBooks, 1, 1);
        ...
        submitButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                ...
                String input = SearchBooks.getText();
                Properties p = new Properties();
                p.setProperty("bookTitle", input);
                clearText();
                myModel.stateChangeRequest("BookCollectionView", p);
            }
        });
