...
//==============================================================
public class SearchPatrons extends View
{
    ...
    //----------------------------------------------------------
    public SearchPatrons(IModel Patron)
    {
    ...
    private VBox createFormContent()
    {
        ...
        Text searchLabel = new Text(" Search For Patrons: ");
        ...
        submitButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                ...
                String input = SearchPatrons.getText();
                Properties p = new Properties();
                p.setProperty("zip", input);
                clearText();
                myModel.stateChangeRequest("PatronCollectionView", p);
            }
        });
