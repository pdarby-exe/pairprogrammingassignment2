...
public class JDBCBroker
{
	...
	// DB Access data
	private String dbName = "spr22_csc429_pdarb1";
	private String username = "pdarb1";
	private String password = "speeder99";
	...
	protected JDBCBroker()
		...
		if (props != null)
		{
			dbName = "spr22_csc429_pdarb1";//props.getProperty("dbName");
			username = "pdarb1";//props.getProperty("username");
			password = "speeder99";//props.getProperty("password");
